...
line1, = ax.plot([],[], 'bo', linewidth = 1, markersize=1*psize, zorder=0)#earth distance from sun
line2, = ax.plot([],[], 'go', linewidth = 1, markersize=0.949*psize, zorder=0)#venus distance from sun
line3, = ax.plot([],[], 'ro', linewidth = 1, markersize=0.383*psize, zorder=0)#mercury distance from sun
